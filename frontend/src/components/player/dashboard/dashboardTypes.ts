...
export type DashboardMysteryRewardSource = {
  id?: string | number;
  name?: string | null;
  thresholdXP?: number;
  threshold_xp?: number;
...
export type DashboardSkillTree = PlayerSkillTree & {
  current_xp?: number;
  title?: string;
  goal?: string;
...
export type PlayerDashboardViewData =
  PlayerDashboard & {
     ...
     */
    check_in?: DashboardCheckIn;
    session_check_in?: DashboardCheckIn;
     ...
     */
    mystery_rewards?: DashboardMysteryRewardSource[];
    mysteryRewards?: DashboardMysteryRewardSource[];

    mystery_prizes?: DashboardMysteryRewardSource[];
    mysteryPrizes?: DashboardMysteryRewardSource[];
